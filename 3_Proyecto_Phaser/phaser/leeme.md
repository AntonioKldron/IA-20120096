...
Este proyecto desarrolla un juego utilizando la biblioteca Phaser y redes neuronales implementadas con Synaptic para controlar la inteligencia artificial del juego. El juego se ejecuta en un canvas de 800x400 píxeles y cuenta con un personaje jugador, varias naves enemigas y proyectiles.
...
function preload() {
    game.load.image('background', 'assets/game/As.jpg');
